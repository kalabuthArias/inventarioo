    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solicitado', models.BooleanField()),
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.elementoarcoiris')),
                ('proveedor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Proveedor.proveedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_entregada', models.IntegerField(blank=True, default=0)),
                ('cantidad_entregada_anterior', models.IntegerField(blank=True, default=0)),
                ('pedido', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.pedidoproveedorpersonal')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.elementoarcoirispersonal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_entregada', models.IntegerField(blank=True, default=0)),
                ('cantidad_entregada_anterior', models.IntegerField(blank=True, default=0)),
                ('pedido', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.pedidoproveedoraseo')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.elementoarcoirisaseo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_entregada', models.IntegerField(blank=True, default=0)),
                ('cantidad_entregada_anterior', models.IntegerField(blank=True, default=0)),
                ('pedido', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.pedidoproveedor')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.elementoarcoiris')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devolucion_pedido_proveedor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.devolucionpedidoproveedorpersonal')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.elementoarcoirispersonal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_devuelta', models.IntegerField()),
                ('motivo', models.CharField(choices=[('PM', 'Producto en mal estado'), ('PV', 'Producto vencido')], max_length=2)),
                ('devolucion_pedido_proveedor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.devolucionpedidoproveedoraseo')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ArcoIris.elementoarcoirisaseo')),
            ],
            options={
                'verbose_name': 'Detalle devolución',
